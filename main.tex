...
\begin{itemize}
    \item \texttt{GET /api/v1/listings?city=Warszawa\&district=Praga\&street=Puławska\&aptNumber=37}
    ...
    \item \texttt{POST /api/v1/listings/\{listingId\}/submit} -- podanie ogłoszenia pod recenzję administratora

    \item \texttt{POST /api/v1/listings/\{listingId\}/request-fixes} -- żądanie poprawek przez administratora

    \item \texttt{POST /api/v1/listings/\{listingId\}/approve} -- akceptacja ogłoszenia przez administratora

    \item \texttt{POST /api/v1/listings/\{listingId\}/hide} -- ukrycie ogłoszenia

    \item \texttt{POST /api/v1/listings/\{listingId\}/publish} -- opublikowanie ukrytego ogłoszenia

    \item \texttt{POST /api/v1/listings/\{listingId\}/archive} -- archiwizacja ogłoszenia
